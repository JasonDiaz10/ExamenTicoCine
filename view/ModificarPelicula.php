...
<body>
    <div class="body_bg">
        ...
        <div class="row">
        <div class="col-12">
          <h2 class="contact-title">Modificar Pelicula</h2>
        </div>
        <div class="col-lg-8">
    ...
    <section>
        <form method="post" action="../Controladores/PeliculaController.php" enctype="multipart/form-data">	
            <input type="text" name="codigo" value="<?=$pelicula->getCodigo();?>" readonly="">
            <input type="text" name="nombre" value="<?=$pelicula->getNombre();?>">
            <input type="text" name="director" value="<?=$pelicula->getDirector();?>">
            <input type="text" name="sinopsis" value="<?=$pelicula->getSinopsis();?>">
            ...
            <label>Nota</label>
            <input type="number" name="puntuacion" min="1" max="10">  
