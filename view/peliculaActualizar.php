                    ...
                    if(count($peliculas) >0):  
                        foreach ($peliculas as $posicion => $pelicula):  ?>
                            <tr>
                                ...
                                <td><img height="120" src="data:image/jpg;base64,<?php echo base64_encode($pelicula->getImagen());?>" ></td>
                                <td><a href="../view/ModificarPelicula.php?codigo=<?=$pelicula->getCodigo();?>">Editar</a></td>
                            </tr>
                <?php
                       endforeach;
                    endif;
